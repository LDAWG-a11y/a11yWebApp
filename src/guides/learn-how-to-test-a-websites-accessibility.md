...
Axe finds these issues with ease, as will other semi-automated tools. These issues could be picked up via code inspection, the Element selector, the DevTools accessibility tree or indeed a screen reader
