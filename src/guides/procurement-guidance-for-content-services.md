...
* PSBAR – [Public Sector Bodies (Websites and Mobile Applications) (No.2) Accessibility Regulations 2018 (PSBAR)](https://www.makethingsaccessible.com/guides/what-are-the-public-sector-bodies-accessibility-regulations/) which requires evidence of compliance with WCAG 2.2.       
  [EU Web Accessibility Directive](https://digital-strategy.ec.europa.eu/en/policies/web-accessibility) – The EU equivalent of PSBAR. Differs between EU members states but all require evidence of compliance with WCAG (under the banner of the EN 301 549 harmonised standard) and an accessibility statement.
