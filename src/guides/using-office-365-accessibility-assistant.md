...
• An example file, [Word-un-accessible.docx](https://www.makethingsaccessible.com/docs/word-un-accessible.docx) **(DOCX 126KB)**, has been created which has issues that need to be corrected
